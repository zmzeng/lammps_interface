...
UFF4MOF_DATA = {
    ...
    "Ni6+2": (1.61, 90.0, 2.834, 0.015, 12, 2.43, 0, 0.7, 4.465, 4.205, 1.398),
    "Ni1": (1.29, 180.0, 2.834, 0.015, 12, 2.43, 0, 0.7, 4.465, 4.205, 1.398),
    ...
    "K_3+1": (2.7, 109.47, 3.812, 0.035, 12, 1.165, 0, 0.7, 2.421, 1.92, 2.586),  # CN 4
